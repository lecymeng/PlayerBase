...
public final class AVPlayer implements IPlayer {
    ...
    private void loadInternalPlayer(int decoderPlanId) {
        ...
        if (mInternalPlayer == null) {
            new Handler(Looper.getMainLooper()).postDelayed(() -> {
                throw new RuntimeException("Execute loadInternalPlayer: init decoder instance failure," +
                        " please check your configuration, maybe your config classpath not found.");
            }, 500L);
        }
    ...
    private final OnPlayerEventListener mInternalPlayerEventListener = new OnPlayerEventListener() {
        @Override
    ...
    private final OnErrorEventListener mInternalErrorEventListener = new OnErrorEventListener() {
        @Override
    ...
    private final OnBufferingListener mInternalBufferingListener = new OnBufferingListener() {
        @Override
    ...
    private final IDataProvider.OnProviderListener mInternalProviderListener = new IDataProvider.OnProviderListener() {
        @Override
    ...
    /**
     * If you want to start play at a specified time, please set this method.
     */
    @Override
